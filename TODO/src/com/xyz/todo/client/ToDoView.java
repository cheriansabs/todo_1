...
import com.xyz.todo.client.ToDoPresenter.ViewEventHandler;
...
public class ToDoView extends Composite implements ToDoPresenter.View {
	...
	public ToDoView() {
		...
		// add IDs to the elements that have ui:field attributes. This is
		// required because the UiBinder
		// does not permit the addition of ID attributes to elements marked with
		// ui:field.
		// *SIGH*
	...
	public void addhandler(final ViewEventHandler handler) {
		...
		// The TodoMVC project template has a markup / style that is not
		// compatible with the markup
		// generated by the GWT CheckBox control. For this reason, here we are
		// using an InputElement
		// directly. As a result, we handle low-level DOM events rather than the
		// GWT higher level
		// abstractions, e.g. ClickHandlers. A typical GWT application would not
		// do this, however,
